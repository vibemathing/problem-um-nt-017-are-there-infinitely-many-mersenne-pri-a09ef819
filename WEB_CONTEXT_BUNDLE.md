...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NT-017"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819-v1",
      "problem_contract_sha256": "be5a133aa3cf82612b6a36879b4effe23ab1ee9bc00dc9e10c3f595d6614d96b",
      "problem_id": "problem:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819",
      "route_id": "route:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819-source-fidelity-01",
      "graph_id": "graph:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are there infinitely many prime numbers of the form $2^p - 1$ where $p$ is prime?"
          },
          "statement_sha256": "75b3cbcd6e830113635ce54ede46325d7de32016c011855abd7f83750284f1b9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819-root",
      "route_id": "route:um-nt-017-are-there-infinitely-many-mersenne-pri-a09ef819-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-nt-017-5da1bd789b35",
        "url": "https://www.unsolvedmath.com/problems/NT-017"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
